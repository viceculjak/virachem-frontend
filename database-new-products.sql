...
INSERT INTO products (name, cas, smiles, mw, purity_options, image_url) VALUES
  ...
  ('HGH Fragment 176-191', 'N/A', NULL, '1859.1 g/mol', ARRAY['≥95%', '≥98%', '≥99%'], '/structures/VC-010.svg'),
  ...
  ('GHRP-6', 'N/A', NULL, '873.0 g/mol', ARRAY['≥95%', '≥98%', '≥99%'], '/structures/VC-014.svg'),
  ...
  ('SLU-PP-332', 'N/A', NULL, '290.3 g/mol', ARRAY['≥95%', '≥98%', '≥99%'], '/structures/VC-030.svg'),
